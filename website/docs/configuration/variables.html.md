...
In cases where a sensitive variable is used in a nested block, this will result in the whole block being redacted. This is because nested blocks represent sets, and when a member of a set is sensitive, the whole set is considered sensitive:
